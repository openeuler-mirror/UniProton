...
#define _NTX_IOC(type,nr)   ((type)|(nr))

/* Terminal I/O ioctl commands **********************************************/

#define _TIOCVALID(c)   (_IOC_TYPE(c)==_TIOCBASE)
#define _TIOC(nr)       _NTX_IOC(_TIOCBASE,nr)
...
#define _WDIOC(nr)      _NTX_IOC(_WDIOCBASE,nr)

/* NuttX file system ioctl definitions **************************************/

#define _FIOCVALID(c)   (_IOC_TYPE(c)==_FIOCBASE)
#define _FIOC(nr)       _NTX_IOC(_FIOCBASE,nr)
...
#define _DIOC(nr)       _NTX_IOC(_DIOCBASE,nr)
...
#define _BIOC(nr)       _NTX_IOC(_BIOCBASE,nr)
...
#define _MTDIOC(nr)       _NTX_IOC(_MTDIOCBASE,nr)
...
#define _CAIOC(nr)        _NTX_IOC(_CAIOCBASE,nr)
...
#define _BATIOC(nr)       _NTX_IOC(_BATIOCBASE,nr)
...
#define _QEIOC(nr)        _NTX_IOC(_QEIOCBASE,nr)
...
#define _AUDIOIOC(nr)     _NTX_IOC(_AUDIOIOCBASE,nr)
...
#define _LCDIOC(nr)       _NTX_IOC(_LCDIOCBASE,nr)
...
#define _SLCDIOC(nr)      _NTX_IOC(_SLCDIOCBASE,nr)
...
#define _WLCIOC(nr)       _NTX_IOC(_WLCIOCBASE,nr)
...
#define _CFGDIOC(nr)      _NTX_IOC(_CFGDIOCBASE,nr)
...
#define _TCIOC(nr)        _NTX_IOC(_TCIOCBASE,nr)
...
#define _RTCIOC(nr)       _NTX_IOC(_RTCBASE,nr)
...
#define _RELAYIOC(nr)     _NTX_IOC(_RELAYBASE,nr)
...
#define _CANIOC(nr)       _NTX_IOC(_CANBASE,nr)
...
#define _BTNIOC(nr)       _NTX_IOC(_BTNBASE,nr)
...
#define _ULEDIOC(nr)      _NTX_IOC(_ULEDBASE,nr)
...
#define _ZCIOC(nr)        _NTX_IOC(_ZCBASE,nr)
...
#define _LOOPIOC(nr)      _NTX_IOC(_LOOPBASE,nr)
...
#define _MODEMIOC(nr)     _NTX_IOC(_MODEMBASE,nr)
...
#define _I2CIOC(nr)       _NTX_IOC(_I2CBASE,nr)
...
#define _SPIIOC(nr)       _NTX_IOC(_SPIBASE,nr)
...
#define _GPIOC(nr)        _NTX_IOC(_GPIOBASE,nr)
...
#define _CLIOC(nr)        _NTX_IOC(_CLIOCBASE,nr)
...
#define _USBCIOC(nr)      _NTX_IOC(_USBCBASE,nr)
...
#define _WLIOC(nr)        _NTX_IOC(_WLIOCBASE,nr)

/* boardctl() command definitions *******************************************/

#define _BOARDIOCVALID(c) (_IOC_TYPE(c)==_BOARDBASE)
#define _BOARDIOC(nr)     _NTX_IOC(_BOARDBASE,nr)
