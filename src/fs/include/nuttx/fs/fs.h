...
int file_allocate_from_tcb(FAR struct TagTskCb *tcb, FAR struct inode *inode,
...
int nx_dup2_from_tcb(FAR struct TagTskCb *tcb, int fd1, int fd2);
...
int nx_open_from_tcb(FAR struct TagTskCb *tcb,
...
int nx_close_from_tcb(FAR struct TagTskCb *tcb, int fd);
...
#ifdef CONFIG_FILE_STREAM
int fs_fdopen(int fd, int oflags, FAR struct TagTskCb *tcb,
