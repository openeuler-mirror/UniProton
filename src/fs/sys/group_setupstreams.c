...
int group_setupstreams()
{
  struct TagTskCb *tcb = RUNNING_TASK;
  ...
  fs_fdopen(0, O_RDONLY,         tcb, NULL);
  fs_fdopen(1, O_WRONLY | O_CREAT, tcb, NULL);
  fs_fdopen(2, O_WRONLY | O_CREAT, tcb, NULL);
