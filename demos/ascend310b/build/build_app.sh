# UniPorton_test_proxy_posix_interface ascend310b UniPorton_test_log_interface UniPorton_test_posix_time_interface UniProton_uros_demo
...
echo "cmake start"
cmake -S .. -B $TMP_DIR -DAPP:STRING=$APP -DTOOLCHAIN_PATH:STRING=$TOOLCHAIN_PATH -DCPU_TYPE:SRTING="ascend310b" -DCMAKE_TRY_COMPILE_TARGET_TYPE=STATIC_LIBRARY
echo "cmake end"
