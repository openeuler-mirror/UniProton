...
/* ***************************** 配置系统基本信息 ******************************* */
/* 芯片主频 */
#define OS_SYS_CLOCK                                    (25000000ull)

#define OS_SYS_TIME_HOOK				NULL

/* ***************************** 中断模块配置 ************************** */
/* 硬中断最大支持个数 */
#define OS_HWI_MAX_NUM_CONFIG                           256
...
/* 缺省的任务栈大小 */
#define OS_TSK_DEFAULT_STACK_SIZE                       0x2000
/* IDLE任务栈的大小 */
...
#define OS_MEM_MAX_PT_NUM                               50
/* 私有FSC内存分区起始地址 */
extern char heap_start[];
extern char heap_end[];
#define OS_MEM_FSC_PT_ADDR                              (U64)(heap_start)
/* 私有FSC内存分区大小 */
#define OS_MEM_FSC_PT_SIZE                              (U64)(heap_end - heap_start)
