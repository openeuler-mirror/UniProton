...
function build()
{
    ...
    cmake -S .. -B $TMP_DIR -DAPP:STRING=$APP -DTOOLCHAIN_PATH:STRING=$TOOLCHAIN_PATH -DCPU_TYPE:SRTING="rk3568_jailhouse" -DCMAKE_TRY_COMPILE_TARGET_TYPE=STATIC_LIBRARY
    pushd $TMP_DIR
    make $APP
    popd
