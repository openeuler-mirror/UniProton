...
patch -d ./gcc-10.3.0 -p1 < $UNIPROTON_PATH/demos/hi3095/component/libstdc++-uniproton.patch

CC_OPTION="-nostdinc -I $UNIPROTON_PATH/demos/hi3095/include/ -I $UNIPROTON_PATH/output/libc/include/"
CXX_OPTION="-I $GCC_PATH/gcc-10.3.0/libstdc++-v3/build/include/ -I $UNIPROTON_PATH/demos/hi3095/include/ -I $UNIPROTON_PATH/output/libc/include/ -I $CXX_COMPILE_PATH/lib64/gcc/aarch64-openeuler-linux-gnu/10.3.1/include -g -nostdlib -nostdinc -nostdinc++"
...
mkdir $UNIPROTON_PATH/demos/hi3095/component/libcxx
mkdir $UNIPROTON_PATH/demos/hi3095/component/libcxx/include && mkdir $UNIPROTON_PATH/demos/hi3095/component/libcxx/lib
cp ./dest/usr/local/lib64/* $UNIPROTON_PATH/demos/hi3095/component/libcxx/lib/
...
cp -r ./destinclude/* $UNIPROTON_PATH/demos/hi3095/component/libcxx/include/
popd
