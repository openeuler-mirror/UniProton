...
├─include         # hi3095网口和串口驱动的编程接口API，/demos/hi3095/CMakeLists.txt中将其添加到头文件搜索路径；
├─libs            # hi3095网口和串口驱动的静态库，/demos/hi3095/CMakeLists.txt中会链接libdriver.a静态库；
└─samples         # 网口和串口驱动的测试用例；

## net sample
1. 编译带网口测试用例的二进制文件
   （1）cd /demos/hi3095/build 
