...
pushd ./../../../../src/component/lua-5.3.4/src
    make posix
    make echo
    cp ./liblua.a ./../../../../boards/armv8/rk3568_jailhouse/libs/
    cp ./lua.h ./../../../../boards/armv8/rk3568_jailhouse/include/
    cp ./luaconf.h ./../../../../boards/armv8/rk3568_jailhouse/include/
    cp ./lualib.h ./../../../../boards/armv8/rk3568_jailhouse/include/
    cp ./lauxlib.h ./../../../../boards/armv8/rk3568_jailhouse/include/
    cp ./lua.hpp ./../../../../boards/armv8/rk3568_jailhouse/include/

    # 临时拷贝，用于排查lua依赖
    cp ./lprefix.h ./../../../../boards/armv8/rk3568_jailhouse/include/
    cp ./lua.c ./../../../../boards/armv8/rk3568_jailhouse/apps/ivshmem/
popd
