...
add_library(DS-D1S  STATIC "${GUEST_SRCS}")
...
####以下为make install打包脚本#####
set(ds-d1s_riscv64_export modules)
...
set(INSTALL_DS-D1S_RISCV64_BASE_DIR                 .)
set(INSTALL_DS-D1S_RISCV64_INCLUDE_DIR              UniProton/include)
set(INSTALL_DS-D1S_RISCV64_INCLUDE_SEC_DIR          libboundscheck/include)
set(INSTALL_DS-D1S_RISCV64_ARCHIVE_DIR              UniProton/lib/ds-d1s)
set(INSTALL_DS-D1S_RISCV64_ARCHIVE_SEC_DIR          libboundscheck/lib/ds-d1s)
set(INSTALL_DS-D1S_RISCV64_ARCHIVE_CONFIG_DIR       UniProton/config)
set(INSTALL_DS-D1S_RISCV64_CONFIG_DIR               cmake/ds-d1s)


include(CMakePackageConfigHelpers)
configure_package_config_file(${PROJECT_SOURCE_DIR}/build/cmake/tool_chain/ds-d1s_riscv64_config.cmake.in
	${CMAKE_CURRENT_BINARY_DIR}/uniproton-ds-d1s-riscv64-config.cmake
	INSTALL_DESTINATION ${INSTALL_DS-D1S_RISCV64_CONFIG_DIR}
	PATH_VARS
	INSTALL_DS-D1S_RISCV64_BASE_DIR
	INSTALL_DS-D1S_RISCV64_INCLUDE_DIR
	INSTALL_DS-D1S_RISCV64_INCLUDE_SEC_DIR
	INSTALL_DS-D1S_RISCV64_ARCHIVE_DIR
	INSTALL_DS-D1S_RISCV64_ARCHIVE_SEC_DIR
	INSTALL_DS-D1S_RISCV64_ARCHIVE_CONFIG_DIR
	INSTALL_DS-D1S_RISCV64_CONFIG_DIR
	INSTALL_PREFIX ${CMAKE_INSTALL_PREFIX}
)
install(EXPORT ${ds-d1s_riscv64_export}
		NAMESPACE UniProton::
		FILE uniproton-ds-d1s-riscv64-targets.cmake
		DESTINATION ${INSTALL_DS-D1S_RISCV64_CONFIG_DIR}
)
install(FILES
	${CMAKE_CURRENT_BINARY_DIR}/uniproton-ds-d1s-riscv64-config.cmake
	DESTINATION ${INSTALL_DS-D1S_RISCV64_CONFIG_DIR}
...
if (${COMPILE_OPTION} STREQUAL "coverity" OR ${COMPILE_OPTION} STREQUAL "fortify" OR ${COMPILE_OPTION} STREQUAL "UniProton")
    ...
    install(TARGETS
		CortexMXsec_c
		EXPORT ${ds-d1s_riscv64_export}
		ARCHIVE DESTINATION ${INSTALL_DS-D1S_RISCV64_ARCHIVE_SEC_DIR}
	)
    ...
    if (NOT "${RPROTON_INSTALL_FILE_OPTION}" STREQUAL "SUPER_BUILD")
        ...
        install(FILES
            ${glob_sec_files}
            DESTINATION ${INSTALL_DS-D1S_RISCV64_INCLUDE_SEC_DIR}
        )
    endif()
endif()
...
install(TARGETS
	DS-D1S
	EXPORT ${ds-d1s_riscv64_export}
	ARCHIVE DESTINATION ${INSTALL_DS-D1S_RISCV64_ARCHIVE_DIR}/
)
...
install(FILES
	${PROJECT_SOURCE_DIR}/build/uniproton_config/config_riscv64_d1s/prt_buildef.h
	DESTINATION ${INSTALL_DS-D1S_RISCV64_ARCHIVE_CONFIG_DIR}/riscv64/ds-d1s
)
...
if (NOT "${LIBCK_INSTALL_FILE_OPTION}" STREQUAL "SUPER_BUILD")
	...
	install(FILES
		...
		DESTINATION ${INSTALL_DS-D1S_RISCV64_ARCHIVE_CONFIG_DIR}
	)
	##{GLOB 所有文件 | GLOB_RECURSE 递归查找文件&文件夹}
	file(GLOB common_include_files  ${PROJECT_SOURCE_DIR}/src/include/uapi/*.h)
	install(FILES
		${common_include_files}
		DESTINATION ${INSTALL_DS-D1S_RISCV64_INCLUDE_DIR}
	)
	...
	install(FILES
		...
		DESTINATION ${INSTALL_DS-D1S_RISCV64_INCLUDE_DIR}/hw/riscv64
	)
