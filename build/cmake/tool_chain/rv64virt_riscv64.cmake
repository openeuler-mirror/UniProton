...
configure_package_config_file(${PROJECT_SOURCE_DIR}/build/cmake/tool_chain/rv64virt_riscv64_config.cmake.in
...
if (${COMPILE_OPTION} STREQUAL "coverity" OR ${COMPILE_OPTION} STREQUAL "fortify" OR ${COMPILE_OPTION} STREQUAL "UniProton")
    ...
    install(TARGETS
		...
		ARCHIVE DESTINATION ${INSTALL_RV64VIRT_RISCV64_ARCHIVE_SEC_DIR}
	)
