...
class CloseCvt1 : public std::codecvt<char, char, std::mbstate_t>
{
public:
...
static void test01()
{
  ...
  const char* name = "/tmp/basic_filebuf_close_char_12790_1";

  CloseCvt1* cvt = new CloseCvt1;
...
int test_27_io_basic_filebuf_close_char_12790_1()
{
  test01();
  return 0;
}
