...
void test01()
{
  ...
  fb.open("/tmp/basic_filebuf_seekoff_wchar_t_9875_seekoff", ios_base::out | ios_base::in | ios_base::trunc);
...
int test_27_io_basic_filebuf_seekoff_wchar_t_9875_seekoff()
{
  test01();
  return 0;
}
