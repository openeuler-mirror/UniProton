...
void test01()
{
  ...
  fb.open("/tmp/basic_filebuf_seekpos_wchar_t_9875_seekpos", ios_base::out | ios_base::in | ios_base::trunc);
...
int test_27_io_basic_filebuf_seekpos_wchar_t_9875_seekpos()
{
  test01();
  return 0;
}
