...
int pthread_exit_2_1_i[3], pthread_exit_2_1_j;
...
void pthread_exit_2_1_a_cleanup_func1(void *dummy)	
{
	pthread_exit_2_1_i[pthread_exit_2_1_j]=1;
	pthread_exit_2_1_j++;
	return;
}
...
/* Cleanup function that the thread executes when it is canceled.  So if
 * cleanup_flag is 1, it means that the thread was canceled. */
void pthread_exit_2_1_a_cleanup_func2(void *dummy)	
{
	pthread_exit_2_1_i[pthread_exit_2_1_j]=2;
	pthread_exit_2_1_j++;
	return;
}
...
/* Cleanup function that the thread executes when it is canceled.  So if
 * cleanup_flag is 1, it means that the thread was canceled. */
void pthread_exit_2_1_a_cleanup_func3(void *dummy)	
{
	pthread_exit_2_1_i[pthread_exit_2_1_j]=3;
	pthread_exit_2_1_j++;
	return;
}
/* Thread's function. */
void *pthread_exit_2_1_a_thread_func()
{
	/* Set up 3 cleanup handlers */
	pthread_cleanup_push(pthread_exit_2_1_a_cleanup_func1,NULL);
	pthread_cleanup_push(pthread_exit_2_1_a_cleanup_func2,NULL);
	pthread_cleanup_push(pthread_exit_2_1_a_cleanup_func3,NULL);
...
int pthread_exit_2_1()
{
	...
	for(pthread_exit_2_1_j=0;pthread_exit_2_1_j<3;pthread_exit_2_1_j++)
		pthread_exit_2_1_i[pthread_exit_2_1_j] = 0;

	/* Initialize counter. */
	pthread_exit_2_1_j=0;

	/* Create a new thread. */
	if(pthread_create(&new_th, NULL, pthread_exit_2_1_a_thread_func, NULL) != 0)
	{	
	...
	if(pthread_exit_2_1_i[0] == 3)
	{
		if(pthread_exit_2_1_i[1] == 2)
		{
			if(pthread_exit_2_1_i[2] == 1)
			{
				printf("Test PASSED\n");
				return PTS_PASS;
	...
	else if(pthread_exit_2_1_i[0] == 0)
	{
