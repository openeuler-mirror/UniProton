 ...
 * void pthread_exit_output_fini()
 * void pthread_exit_output(char * string, ...)
 * 
 * The are used to pthread_exit_output informative text (as a printf).
 */
...
/******************************* stdout module *****************************************/
/*****************************************************************************************/
/* The following functions will pthread_exit_output to stdout */
#if (1)
static void pthread_exit_output_init()
{
	/* do nothing */
	return;
}
static void pthread_exit_output( char * string, ... )
{
   va_list ap;
   char *ts="[??:??:??]";
   struct tm * now;
...
static void pthread_exit_output_fini()
{
	/*do nothing */
	return;
}
