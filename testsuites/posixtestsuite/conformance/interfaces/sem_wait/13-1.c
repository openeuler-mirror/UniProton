...
* -> Register a signal sem_wait_13_1_handler for SIGALRM which post the semaphore
* -> save current time
 ...
 * void sem_wait_output_init()
 * void sem_wait_output(char * string, ...)
 * 
 * Those may be used to sem_wait_output information.
 */
...
/***************************    Test case   ***********************************/
/******************************************************************************/
sem_t sem_wait_13_1_sem;

void sem_wait_13_1_handler( int sig )
{
	int ret;
	ret = sem_post( &sem_wait_13_1_sem );
...
int sem_wait_13_1( int argc, char * argv[] )
{
	int ret;
	...
	/* Initialize sem_wait_output */
	sem_wait_output_init();

	/* Initialize semaphore */
	ret = sem_init( &sem_wait_13_1_sem, 0, 0 );
	...
	/* Register signal sem_wait_13_1_handler */
	sa.sa_flags = 0;

	sa.sa_handler = sem_wait_13_1_handler;
	...
	if ( ret != 0 )
	{
		UNRESOLVED( ret, "Failed to set signal sem_wait_13_1_handler" );
	}
	...
	ret = sem_wait( &sem_wait_13_1_sem );
