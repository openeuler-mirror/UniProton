...
#include <stdlib.h>
#include "posixtest.h"
#define CLOCK_SETTIME_GET_BEFORE_TIME clock_settime_4_4_getBeforeTime
#define CLOCK_SETTIME_SET_BEFORE_BACK clock_settime_4_4_setBackTime
#include "../helpers.h"
...
int clock_settime_4_4_caught = 0;

void clock_settime_4_4_handler(int signo)
{
	printf("Caught signal\n");
	clock_settime_4_4_caught++;
}

int clock_settime_4_4(int argc, char *argv[])
{
	struct sigevent ev;
	...
	act.sa_handler=clock_settime_4_4_handler;
	act.sa_flags=0;
	...
	CLOCK_SETTIME_SET_BEFORE_BACK(tsreset);
	return PTS_PASS;
}
