...
#include <stdlib.h>
#include "posixtest.h"
#define CLOCK_SETTIME_GET_BEFORE_TIME clock_settime_4_2_getBeforeTime
#define CLOCK_SETTIME_SET_BEFORE_BACK clock_settime_4_2_setBackTime
#include "helpers.h"
...
struct timespec clock_settime_4_2_tpreset;

void clock_settime_4_2_handler(int signo)
{
	printf("Caught signal\n");
	printf("Test PASSED\n");
	CLOCK_SETTIME_SET_BEFORE_BACK(clock_settime_4_2_tpreset);
	return PTS_PASS ;
}

int clock_settime_4_2(int argc, char *argv[])
{
	struct sigevent ev;
	...
	act.sa_handler=clock_settime_4_2_handler;
	act.sa_flags=0;
	...
	CLOCK_SETTIME_GET_BEFORE_TIME(&clock_settime_4_2_tpreset);
	...
	clock_settime_4_2_tpreset.tv_sec += SHORTTIME;
	CLOCK_SETTIME_SET_BEFORE_BACK(clock_settime_4_2_tpreset);
	return PTS_FAIL;
}
