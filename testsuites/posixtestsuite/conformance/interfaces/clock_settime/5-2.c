...
#include <stdlib.h>
#include "posixtest.h"
#define CLOCK_SETTIME_GET_BEFORE_TIME clock_settime_5_2_getBeforeTime
#define CLOCK_SETTIME_SET_BEFORE_BACK clock_settime_5_2_setBackTime
#include "helpers.h"
...
void clock_settime_5_2_handler(int signo)
{
	printf("Caught signal\n");
}

int clock_settime_5_2(int argc, char *argv[])
{
	struct sigevent ev;
	...
	act.sa_handler=clock_settime_5_2_handler;
	act.sa_flags=0;
