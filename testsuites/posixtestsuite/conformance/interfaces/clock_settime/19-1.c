...
#include <stdint.h>
#include "posixtest.h"
#define CLOCK_SETTIME_GET_BEFORE_TIME clock_settime_19_1_getBeforeTime
#define CLOCK_SETTIME_SET_BEFORE_BACK clock_settime_19_1_setBackTime
#include "helpers.h"

#define NUMINVALIDTESTS 9

static int clock_settime_19_1_invalid_tests[NUMINVALIDTESTS] = {
		INT32_MIN, INT32_MAX, 2147483647, -2147483647, -1073743192, 
		1073743192, -1, 1000000000, 1000000001
};

int clock_settime_19_1(int argc, char *argv[])
{
	...
	for (i = 0; i < NUMINVALIDTESTS; i++) {
		...
		tsset.tv_nsec = clock_settime_19_1_invalid_tests[i];
