 ...
 *
 * Steps:
 * 1.  Initialize a pthread_rwlock_t object 'pthread_rwlock_init_3_1_rwlock' with pthread_rwlock_init()
...
static pthread_rwlock_t pthread_rwlock_init_3_1_rwlock; 

 
int pthread_rwlock_init_3_1()
{
	int cnt = 0;
	...
	if(pthread_rwlock_init(&pthread_rwlock_init_3_1_rwlock, &rwlockattr) != 0)
	{
	...
	while(cnt++ < COUNT)
	{
		if(pthread_rwlock_rdlock(&pthread_rwlock_init_3_1_rwlock) != 0)
		{
			printf("Test FAILED: cannot get read lock on %dth loop\n", cnt);
			return PTS_FAIL;
		}
		
		if(pthread_rwlock_unlock(&pthread_rwlock_init_3_1_rwlock) != 0)
		{
			printf("Test FAILED: cannot release read lock on %dth loop\n", cnt);
			return PTS_FAIL;
		}
		
		if(pthread_rwlock_wrlock(&pthread_rwlock_init_3_1_rwlock) != 0)
		{
	...
	if(pthread_rwlock_destroy(&pthread_rwlock_init_3_1_rwlock) != 0)
	{
