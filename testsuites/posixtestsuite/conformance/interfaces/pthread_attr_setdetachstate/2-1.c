...
void *pthread_attr_setdetachstate_2_1_a_thread_func()
{
...
int pthread_attr_setdetachstate_2_1()
{
	pthread_t new_th;
	...
	if(pthread_create(&new_th, &new_attr, pthread_attr_setdetachstate_2_1_a_thread_func, NULL) != 0)
	{	
