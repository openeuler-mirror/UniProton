...
int pthread_attr_getinheritsched_1_1_verify_inheritsched(pthread_attr_t *attr, int schedtype) {
	int rc;
	int inheritsched;
...
int pthread_attr_getinheritsched_1_1()
{
	int                   rc=0;
	pthread_attr_t        attr;
	...
	if( rc != 0) {
  	...
  	pthread_attr_getinheritsched_1_1_verify_inheritsched(&attr, INHERIT);
	...
	if( rc != 0) {
  	...
  	pthread_attr_getinheritsched_1_1_verify_inheritsched(&attr, EXPLICIT);
