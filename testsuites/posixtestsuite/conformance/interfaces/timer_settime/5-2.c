 ...
 * - If signal timer_settime_5_2_handler is not called after a sufficient amount of sleeping,
 *   fail.
...
void timer_settime_5_2_handler(int signo)
{
...
int timer_settime_5_2(int argc, char *argv[])
{
	struct sigevent ev;
	...
	act.sa_handler=timer_settime_5_2_handler;
	act.sa_flags=0;
