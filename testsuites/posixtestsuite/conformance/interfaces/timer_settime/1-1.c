 ...
 * 5.  If signal timer_settime_1_1_handler is called, continue.  Otherwise, fail.
 * 6.  If signal timer_settime_1_1_handler was called and the time left in sleep ~= the
...
void timer_settime_1_1_handler(int signo)
{
	printf("Caught signal\n");
}

int timer_settime_1_1(int argc, char *argv[])
{
	struct sigevent ev;
	...
	act.sa_handler=timer_settime_1_1_handler;
	act.sa_flags=0;
