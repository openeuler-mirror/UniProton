 ...
 * 5.  Fail if signal timer_settime_3_1_handler is called.
 * 6.  If signal timer_settime_3_1_handler is not called, then PASS.
 *
...
void timer_settime_3_1_handler(int signo)
{
	printf("Incorrectly in signal timer_settime_3_1_handler\n");
	printf("Test FAILED\n");
	return PTS_FAIL ;
}

int timer_settime_3_1(int argc, char *argv[])
{
	struct sigevent ev;
	...
	act.sa_handler=timer_settime_3_1_handler;
	act.sa_flags=0;
