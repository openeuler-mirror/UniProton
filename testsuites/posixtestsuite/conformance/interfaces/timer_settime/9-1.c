...
static int timer_settime_9_1_timeroffsets[NUMTESTS][2] = { {0, 30000000}, {1, 0}, 
					{1, 30000000}, {2, 0},
					{1, 5000}, {1, 5} };

int timer_settime_9_1(int argc, char *argv[])
{
	struct sigevent ev;
	timer_t tid;
	...
	for (i = 0; i < NUMTESTS; i++) {
		...
		its.it_value.tv_sec = timer_settime_9_1_timeroffsets[i][0];
		its.it_value.tv_nsec = timer_settime_9_1_timeroffsets[i][1];
