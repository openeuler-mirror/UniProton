 ...
 */
static int timer_settime_13_1_testlist[NUMTESTS][4] = { 
...
int timer_settime_13_1(int argc, char *argv[])
{
	struct sigevent ev;
	timer_t tid;
	...
	for (i = 0; i < NUMTESTS; i++) {
		its.it_value.tv_sec = timer_settime_13_1_testlist[i][0];
		its.it_value.tv_nsec = timer_settime_13_1_testlist[i][1];
		its.it_interval.tv_sec = timer_settime_13_1_testlist[i][2];
		its.it_interval.tv_nsec = timer_settime_13_1_testlist[i][3];
