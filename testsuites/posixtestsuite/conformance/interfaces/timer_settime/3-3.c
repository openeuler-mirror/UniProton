...
void timer_settime_3_3_handler(int signo)
{
	printf("OK to be in once\n");
}

int timer_settime_3_3(int argc, char *argv[])
{
	sigset_t set;
	struct sigevent ev;
	...
	/*
	 * Second, set value.it_value = 0 and set up timer_settime_3_3_handler to catch
	 * signal.
	 */
	act.sa_handler=timer_settime_3_3_handler;
	act.sa_flags=0;
