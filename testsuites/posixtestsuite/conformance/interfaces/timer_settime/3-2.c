...
void timer_settime_3_2_handler(int signo)
{
	printf("Incorrectly in signal timer_settime_3_2_handler\n");
	printf("Test FAILED\n");
	return PTS_FAIL ;
}

int timer_settime_3_2(int argc, char *argv[])
{
	struct sigevent ev;
	...
	act.sa_handler=timer_settime_3_2_handler;
	act.sa_flags=0;
