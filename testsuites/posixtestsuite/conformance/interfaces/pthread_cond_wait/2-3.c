 ...
 */
void pthread_cond_wait_2_3_clnp1 (void * arg)
{
	int ret;
 ...
 */
void pthread_cond_wait_2_3_clnp2 (void * arg)
{
	int ret;
	do {
 ...
 */
void pthread_cond_wait_2_3_clnp3 (void * arg)
{
	int ret;
 ...
 */
void * pthread_cond_wait_2_3_threaded (void * arg)
{
	int ret;
	...
	pthread_cleanup_push ( pthread_cond_wait_2_3_clnp3, NULL);
	pthread_cleanup_push ( pthread_cond_wait_2_3_clnp2, NULL);
	pthread_cleanup_push ( pthread_cond_wait_2_3_clnp1, NULL);
...
int pthread_cond_wait_2_3(int argc, char * argv[])
{
	int ret, i;
	void * rc;
	...
	for (i=0; i< (sizeof(scenar) / sizeof(scenar[0])); i++)
	{
		...
		ret = pthread_create(&th, NULL, pthread_cond_wait_2_3_threaded, NULL);
