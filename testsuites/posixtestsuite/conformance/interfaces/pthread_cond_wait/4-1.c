...
void * pthread_cond_wait_4_1_sendsig (void * arg)
{
...
void pthread_cond_wait_4_1_sighdl1(int sig)
{
#ifdef WITH_SYNCHRO
	if (sem_post(&semsig1))
...
void pthread_cond_wait_4_1_sighdl2(int sig)
{
#ifdef WITH_SYNCHRO
	if (sem_post(&semsig2))
...
void * pthread_cond_wait_4_1_waiter(void * arg)
{
	int ret;
...
void * pthread_cond_wait_4_1_worker (void * arg)
{
	int ret=0;
...
/* Main function */
int pthread_cond_wait_4_1 (int argc, char * argv[])
{
	int ret;
	...
	sa.sa_flags = 0;
	sa.sa_handler = pthread_cond_wait_4_1_sighdl1;
	if ((ret = sigaction (SIGUSR1, &sa, NULL)))
	{ UNRESOLVED(ret, "Unable to register signal handler1"); }
	sa.sa_handler = pthread_cond_wait_4_1_sighdl2;
	...
	if ((ret = pthread_create(&th_waiter, NULL, pthread_cond_wait_4_1_waiter, NULL)))
	{ UNRESOLVED(ret, "Waiter thread creation failed"); }
	
	if ((ret = pthread_create(&th_worker, NULL, pthread_cond_wait_4_1_worker, NULL)))
	...
	if ((ret = pthread_create(&th_sig1, NULL, pthread_cond_wait_4_1_sendsig, (void *)&arg1)))
	{ UNRESOLVED(ret, "Signal 1 sender thread creation failed"); }
	if ((ret = pthread_create(&th_sig2, NULL, pthread_cond_wait_4_1_sendsig, (void *)&arg2)))
