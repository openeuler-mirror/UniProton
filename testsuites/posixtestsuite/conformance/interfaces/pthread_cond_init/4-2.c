...
void * pthread_cond_init_4_2_sendsig (void * arg)
{
...
void pthread_cond_init_4_2_sighdl1(int sig)
{
#ifdef WITH_SYNCHRO
	if (sem_post(&semsig1))
...
void pthread_cond_init_4_2_sighdl2(int sig)
{
#ifdef WITH_SYNCHRO
	if (sem_post(&semsig2))
...
void * pthread_cond_init_4_2_threaded(void * arg)
{
	...
	sa.sa_flags = 0;
	sa.sa_handler = pthread_cond_init_4_2_sighdl1;
	if ((ret = sigaction (SIGUSR1, &sa, NULL)))
	{ UNRESOLVED(ret, "Unable to register signal handler1"); }
	sa.sa_handler = pthread_cond_init_4_2_sighdl2;
...
/* Main function */
int pthread_cond_init_4_2(int argc, char * argv[])
{
	int ret;
	...
	if ((ret = pthread_create(&th_work, NULL, pthread_cond_init_4_2_threaded, NULL)))
	...
	if ((ret = pthread_create(&th_sig1, NULL, pthread_cond_init_4_2_sendsig, (void *)&arg1)))
	{ UNRESOLVED(ret, "Signal 1 sender thread creation failed"); }
	if ((ret = pthread_create(&th_sig2, NULL, pthread_cond_init_4_2_sendsig, (void *)&arg2)))
