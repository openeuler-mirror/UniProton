...
int pthread_attr_setstack_4_1_teststack() {
	return 0;
}
void *pthread_attr_setstack_4_1_thread_func()
{
	/* execute a function to test the read/right of the stack*/
	if (pthread_attr_setstack_4_1_teststack() != 0) {
...
int pthread_attr_setstack_4_1()
{
	...
	rc = pthread_create(&new_th, &attr, pthread_attr_setstack_4_1_thread_func, NULL);
	if (rc !=0 ) {
