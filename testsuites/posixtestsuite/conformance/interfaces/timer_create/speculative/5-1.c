 ...
 * 4.  If signal timer_create_5_1_compare is called, continue.  Otherwise, fail.
 * 5.  If signal timer_create_5_1_compare was called and the time left in sleep ~= the
...
void timer_create_5_1_compare(int signo)
{
	printf("Caught signal\n");
}

int timer_create_5_1(int argc, char *argv[])
{
	...
	act.sa_handler=timer_create_5_1_compare;
	act.sa_flags=0;
