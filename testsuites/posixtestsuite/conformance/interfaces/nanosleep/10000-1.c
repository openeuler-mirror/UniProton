 ...
 * input tests
 */
static int nanosleep_10000_1_sleepvalid[NUMVALID][2] = { {0, 30000000}, {1, 0}, 
					{1, 30000000}, {2, 0},
					{10, 5000}, {13, 5} };
static int nanosleep_10000_1_sleepinvalid[NUMINVALID][2] = { {-1, -1}, {0, -1}, 
...
int nanosleep_10000_1(int argc, char *argv[])
{
	...
	for (i=0; i<NUMVALID;i++) {
		tssleepfor.tv_sec=nanosleep_10000_1_sleepvalid[i][0];
		tssleepfor.tv_nsec=nanosleep_10000_1_sleepvalid[i][1];
	...
	for (i=0; i<NUMINVALID;i++) {
		tssleepfor.tv_sec=nanosleep_10000_1_sleepinvalid[i][0];
		tssleepfor.tv_nsec=nanosleep_10000_1_sleepinvalid[i][1];
		printf("sleep %d sec %d nsec\n", 
				(int) tssleepfor.tv_sec,
				(int) tssleepfor.tv_nsec);
