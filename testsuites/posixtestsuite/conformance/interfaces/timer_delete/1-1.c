 ...
 *   timer_delete_1_1_handler to catch it.
 * - Activate the timer.
...
void timer_delete_1_1_handler(int signo)
{
	printf("Should not have caught signal\n");
	return PTS_FAIL ;
}

int timer_delete_1_1(int argc, char *argv[])
{
	struct sigevent ev;
	...
	act.sa_handler=timer_delete_1_1_handler;
	act.sa_flags=0;
