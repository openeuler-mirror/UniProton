...
char pthread_create_14_1_do_it=1;
char pthread_create_14_1_woken=0;
unsigned long pthread_create_14_1_count_ope=0;
#ifdef WITH_SYNCHRO
sem_t pthread_create_14_1_semsig1;
sem_t pthread_create_14_1_semsig2;
unsigned long pthread_create_14_1_count_sig=0;
#endif

sigset_t pthread_create_14_1_usersigs;
...
typedef struct 
{
	...
	sem_t	*sem;
#endif
} pthread_create_14_1_thestruct;

/* the following function keeps on sending the signal to the process */
void * pthread_create_14_1_sendsig (void * arg)
{
	pthread_create_14_1_thestruct *thearg = (pthread_create_14_1_thestruct *) arg;
	int ret;
	pid_t process;
	...
	ret = pthread_sigmask(SIG_BLOCK, &pthread_create_14_1_usersigs, NULL);
	if (ret != 0)  {  UNRESOLVED(ret, "Unable to block SIGUSR1 and SIGUSR2 in signal thread");  }

	while (pthread_create_14_1_do_it)
	{
		#ifdef WITH_SYNCHRO
		if ((ret = sem_wait(thearg->sem)))
		{ UNRESOLVED(errno, "Sem_wait in pthread_create_14_1_sendsig"); }
		pthread_create_14_1_count_sig++;
		#endif

		ret = kill(process, thearg->sig);
		if (ret != 0)  { UNRESOLVED(errno, "Kill in pthread_create_14_1_sendsig"); }
...
void pthread_create_14_1_sighdl1(int sig)
{
#ifdef WITH_SYNCHRO
	if (sem_post(&pthread_create_14_1_semsig1))
	{ UNRESOLVED(errno, "Sem_post in signal handler 1"); }
#endif
}
/* This one is registered for signal SIGUSR2 */
void pthread_create_14_1_sighdl2(int sig)
{
#ifdef WITH_SYNCHRO
	if (sem_post(&pthread_create_14_1_semsig2))
	{ UNRESOLVED(errno, "Sem_post in signal handler 2"); }
#endif	
}

/* Thread function -- almost does nothing */
void * pthread_create_14_1_threaded(void * arg)
{
	int ret;
...
void * pthread_create_14_1_test(void * arg)
{
	int ret=0;
	pthread_t child;
	
 	/* We don't block the signals SIGUSR1 and SIGUSR2 for this THREAD */
	ret = pthread_sigmask(SIG_UNBLOCK, &pthread_create_14_1_usersigs, NULL);
	...
	while (pthread_create_14_1_do_it)
	{
		...
		pthread_create_14_1_count_ope++;
		
		ret = pthread_create(&child, &pthread_create_scenarii[pthread_create_sc].ta, pthread_create_14_1_threaded, NULL);
		...
		pthread_create_sc++;
		pthread_create_sc %= NSCENAR;
	}
	return NULL;
}

/* Main function */
int pthread_create_14_1 (int argc, char * argv[])
{
	int ret;
	pthread_t th_work, th_sig1, th_sig2;
	pthread_create_14_1_thestruct arg1, arg2;
	struct sigaction sa;
	...
	sa.sa_flags = 0;
	sa.sa_handler = pthread_create_14_1_sighdl1;
	if ((ret = sigaction (SIGUSR1, &sa, NULL)))
	{ UNRESOLVED(ret, "Unable to register signal handler1"); }
	sa.sa_handler = pthread_create_14_1_sighdl2;
	if ((ret = sigaction (SIGUSR2, &sa, NULL)))
	{ UNRESOLVED(ret, "Unable to register signal handler2"); }

	/* We prepare a signal set which includes SIGUSR1 and SIGUSR2 */
	sigemptyset(&pthread_create_14_1_usersigs);
	ret = sigaddset(&pthread_create_14_1_usersigs, SIGUSR1);
	ret |= sigaddset(&pthread_create_14_1_usersigs, SIGUSR2);
	...
	#ifdef WITH_SYNCHRO
	if (sem_init(&pthread_create_14_1_semsig1, 0, 1))
	{ UNRESOLVED(errno, "Semsig1  init"); }
	if (sem_init(&pthread_create_14_1_semsig2, 0, 1))
	{ UNRESOLVED(errno, "Semsig2  init"); }
	#endif
	
	if ((ret = pthread_create(&th_work, NULL, pthread_create_14_1_test, NULL)))
	{ UNRESOLVED(ret, "Worker thread creation failed"); }
	
	arg1.sig = SIGUSR1;
	arg2.sig = SIGUSR2;
#ifdef WITH_SYNCHRO
	arg1.sem = &pthread_create_14_1_semsig1;
	arg2.sem = &pthread_create_14_1_semsig2;
#endif
	
	if ((ret = pthread_create(&th_sig1, NULL, pthread_create_14_1_sendsig, (void *)&arg1)))
	{ UNRESOLVED(ret, "Signal 1 sender thread creation failed"); }
	if ((ret = pthread_create(&th_sig2, NULL, pthread_create_14_1_sendsig, (void *)&arg2)))
	...
	do { pthread_create_14_1_do_it=0; }
	while (pthread_create_14_1_do_it);
	...
	#if VERBOSE > 0
	pthread_create_output("Test executed successfully.\n");
	pthread_create_output("  %d thread creations.\n", pthread_create_14_1_count_ope);
	#ifdef WITH_SYNCHRO
	pthread_create_output("  %d signals were sent meanwhile.\n", pthread_create_14_1_count_sig);
	#endif 
	#endif	
	printf("Test PASS\n");
	PASSED;
