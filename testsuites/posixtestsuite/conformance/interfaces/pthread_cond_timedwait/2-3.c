...
void *pthread_cond_timedwait_2_3_t1_func(void *arg)
{
	int rc;
...
int pthread_cond_timedwait_2_3()
{
	pthread_t  thread1;
	int rc, th_ret;
	...
	if (pthread_create(&thread1, NULL, pthread_cond_timedwait_2_3_t1_func, NULL) != 0) {
