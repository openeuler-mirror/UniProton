...
void *pthread_cond_timedwait_1_1_t1_func(void *arg)
{
	int rc;
...
int pthread_cond_timedwait_1_1()
{
	pthread_t  thread1;
	...
	if (pthread_create(&thread1, NULL, pthread_cond_timedwait_1_1_t1_func, NULL) != 0) {
