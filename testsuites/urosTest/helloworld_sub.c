...
static int ros_msg_subscriber(void)
{
  rcl_ret_t ret;
  ...
  RCCHECK(rclc_subscription_init_default(&subscriber, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, String), "/chatter"));
...
static void SubTaskEntry()
{
    printf("[TEST] ros sub task entry\n");
...
U32 RosSubTest()
{
    ...
    param.taskEntry = (TskEntryFunc)SubTaskEntry;
    param.name = "chatter_sub";
    param.taskPrio = 25;
